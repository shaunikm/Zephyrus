    ...
    <header className="w-full sticky-nav">
      <div className="flex flex-col flex-wrap max-w-5xl p-2.5 mx-auto md:flex-row">
        <div className="flex flex-row items-center justify-between p-2 md:p-1">
          <Link href="/">
            <a className="mb-4 text-2xl font-medium text-darkvanilla transition duration-300 hover:text-offwhite dark:text-darkvanilla dark:hover:text-offwhite md:mb-0">
              ZEPHYRUS
            </a>
          </Link>
          <button
        ...
        >
          ...
          <button
            ...
            type="button"
            className="w-10 h-10 p-3 ml-5 mr-0 bg-uranianBlue rounded md:ml-0 md:mr-5 dark:bg-uranianBlue"
          ...
          <a
            ...
            rel="noopener noreferrer"
            target="_blank"
            className="invisible md:visible px-3 py-1.5 transition-colors hover:bg-uranianBlue dark:hover:bg-uranianBlue text-offwhite dark:text-darkvanilla bg-uranianBlue dark:bg-offwhite rounded"
          >
