  ...
  return (
    <section className="pb-10" id="sponsors">
      <div className="px-4 pb-16 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <h1 className="mb-8 text-2xl font-bold tracking-normal text-center text-darkvanilla md:leading-tight md:tracking-normal dark:text-darkvanilla md:text-4xl">
